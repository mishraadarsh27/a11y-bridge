# Bhasa-Setu(CommuniBridge): A hybrid bidirectional communication model using ResNet18 and LSTM

A multilingual, real-time, bidirectional communication bridge enabling deaf, hard-of-hearing, non-verbal, and blid users to communicate with everyone. It supports:
